...
function initialization() {
	source "~/.config/tiling-workspace/network-manager.conf" || source "~/.config/tiling-workspace/network-manager.conf"
	{ [[ -f "~/.config/tiling-workspace/rofi/networkmanager.rasi" ]] && RASI_DIR="~/.config/tiling-workspace/rofi/networkmanager.rasi"; } || { [[ -f "~/.config/tiling-workspace/rofi/networkmanager.rasi" ]] && RASI_DIR="~/.config/tiling-workspace/rofi/networkmanager.rasi"; } || exit
